...
import com.example.abhay.a4_cast.Activities.AlarmReceiver;
import com.example.abhay.a4_cast.Activities.Constants;
import com.example.abhay.a4_cast.Activities.adapters.ViewPagerAdapter;
import com.example.abhay.a4_cast.Activities.fragments.RecyclerViewFragment;
import com.example.abhay.a4_cast.Activities.models.Weather;
import com.example.abhay.a4_cast.Activities.tasks.GenericRequestTask2;
import com.example.abhay.a4_cast.Activities.tasks.ParseResult;
import com.example.abhay.a4_cast.Activities.tasks.TaskOutput;
import com.example.abhay.a4_cast.Activities.utils.UnitConvertor;
import com.example.abhay.a4_cast.Activities.widgets.AbstractWidgetProvider;
...
public class MainActivityDetails extends AppCompatActivity implements LocationListener {
    ...
    private void preloadWeather() {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(MainActivityDetails.this);

        String lastToday = sp.getString("lastToday", "");
        if (!lastToday.isEmpty()) {
            new MainActivityDetails.TodayWeatherTask(this, this, progressDialog).execute("cachedResponse", lastToday);
        }
        String lastLongterm = sp.getString("lastLongterm", "");
        if (!lastLongterm.isEmpty()) {
            new MainActivityDetails.LongTermWeatherTask(this, MainActivityDetails.this, progressDialog).execute("cachedResponse", lastLongterm);
        }
    }

    private void getTodayWeather() {
        new MainActivityDetails.TodayWeatherTask(this, this, progressDialog).execute();
    }

    private void getLongTermWeather() {
        new MainActivityDetails.LongTermWeatherTask(this, MainActivityDetails.this, progressDialog).execute();
    }
    private void saveLocation(String result) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(MainActivityDetails.this);
    ...
    private ParseResult parseTodayJson(String result) {
        try {
            ...
            SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(MainActivityDetails.this).edit();
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            progressDialog.setButton(DialogInterface.BUTTON_NEGATIVE, getString(R.string.dialog_cancel), new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    try {
                        locationManager.removeUpdates(MainActivityDetails.this);
    ...
    public void onLocationChanged(Location location) {
        ...
        new MainActivityDetails.ProvideCityNameTask(this, this, progressDialog).execute("coords", Double.toString(latitude), Double.toString(longitude));
    }
    ...
    class TodayWeatherTask extends GenericRequestTask2 {
        public TodayWeatherTask(Context context, MainActivityDetails activity, ProgressDialog progressDialog) {
        ...
        protected void onPostExecute(TaskOutput output) {
            ...
            // Update widgets
            AbstractWidgetProvider.updateWidgets(MainActivityDetails.this);
//            DashClockWeatherExtension.updateDashClock(MainActivity.this);
    ...
    class LongTermWeatherTask extends GenericRequestTask2 {
        public LongTermWeatherTask(Context context, MainActivityDetails activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
    ...
    class ProvideCityNameTask extends GenericRequestTask2 {
        ...
        public ProvideCityNameTask(Context context, MainActivityDetails activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
