package com.example.abhay.a4_cast.Activities.tasks;
...
import com.example.abhay.a4_cast.Activities.activities.MainActivity;
import com.example.abhay.a4_cast.Activities.activities.MainActivityDetails;
...
public abstract class GenericRequestTask2 extends AsyncTask<String, String, TaskOutput> {

    ProgressDialog progressDialog;
    Context context;
    MainActivityDetails activity;

    public int loading = 0;

    public GenericRequestTask2(Context context, MainActivityDetails activity, ProgressDialog progressDialog) {
