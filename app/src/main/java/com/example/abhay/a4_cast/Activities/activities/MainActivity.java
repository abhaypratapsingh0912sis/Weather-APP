...
import com.example.abhay.a4_cast.Activities.adapters.WeatherRecyclerAdapter;
...
import com.example.abhay.a4_cast.Activities.tasks.GenericRequestTask;
...
import com.example.abhay.a4_cast.Activities.widgets.DashClockWeatherExtension;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    private void aboutDialog() {
        AlertDialog.Builder alert = new AlertDialog.Builder(this);
        alert.setTitle("4Cast");
        final WebView webView = new WebView(this);
        String about = "<p>1.0</p>" +
                "<p>A lightweight, opensource weather app .</p>" +
                "<p>Developed by <a href='mailto:t.abhaypratapsingh0912@gmail.com'>Abhay Pratap Singh</a></p>" +
                "<p>Data provided by <a href='http://openweathermap.org/'>OpenWeatherMap</a></p>" +
                "<p>Icons are <a href='https://erikflowers.github.io/weather-icons/'>Weather Icons</a></p>";
    ...
    private void updateTodayWeatherUI() {
        ...
        today_temp = new DecimalFormat("0.#").format(temperature) + " " + sp.getString("unit", "°C");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_share) {
            try {
                ...
                String sAux = "\n I Like share my current weather report which is : \n\n"+today_temp;
